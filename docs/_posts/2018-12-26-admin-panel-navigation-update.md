...
- Added new notification bar
- Added event status label (“Published” in screenshot)
- Added gear icon that leads to Edit Event Details
- Renamed Users to Guests
- Combined RSVP and Check-in App into Registration
- Renamed Features to App and included top-level app features such as Feed, Push
- Notifications, Languages, Projectors and Live Slides
- Projector Screen
...
- Added simple instructions on how to operate the projector screen in just 3 steps.
- Grouped customisable options and made them easier to understand.
- Moved Launch, Edit, Freeze, Delete buttons into icons when you hover the projector screen row.
- Content Groups
